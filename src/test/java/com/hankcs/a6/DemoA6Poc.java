...
//    		if(baseDecoder(a6Text.getNickName().replaceAll("\"", "")).equals("Harvey")) {
    			if(labelMap.get(a6Text.getNickName()) == null) {
        			labelMap.put(a6Text.getNickName(), getLabel(a6Text.getText()));
        		}else {
        			labelMap.get(a6Text.getNickName()).addAll(getLabel(a6Text.getText()));
        		}
//    		}
